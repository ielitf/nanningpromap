...
public class MinaClientHandler extends IoHandlerAdapter {
        ...
        public void download(int status, int result) {
            ...
            if (FileDownload.DOWNLOAD_FINISHED == status) {
                if (FileDownload.SUCCESS == result) {
                    respone = ProtocolMessageProcess.makeMsgCCommonSetting(devInfo.identify,
    ...
    public void sessionOpened(IoSession session) throws Exception {
        ...
        byte[] msg_CMulticast = ProtocolMessageProcess.makeMsgCMulticast(
                localIp, localMac,
                deviceInfo.devType, deviceInfo.identify, (int) (SystemInfoUtils.getAvailableExternalMemorySize() / 1024 / 1024),
                null, null, null, null);
    ...
    public void messageReceived(IoSession session, Object message) throws Exception {
        ...
        switch (msg_type) {
            ...
            case ProtocolMessageProcess.TYPE_DispSetting:
                ...
                ProtocolMessageProcess.msgProcessHDispSetting(hDispSetting, session, deviceInfo);
